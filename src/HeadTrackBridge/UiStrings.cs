...
public sealed class UiStrings
{
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        // The two resets are next to each other in the menu and were being read
        // as the same thing. These say which is which, on hover.
        ["vr.resetView.hint"] =
            "Point the picture straight ahead again, undoing any mouse drag or keyboard look. "
            + "Works whether or not head tracking is on.",
        ["vr.recenter.hint"] =
            "Take your head where it is right now as the new neutral. Use it after you have "
            + "shifted in your seat. Head tracking only.",
        // Keys shown beside menu entries. Names, not bindings — the bindings
        // live in mpv/input.conf.
        ["key.wheelUp"] = "wheel up",
        ["key.wheelDown"] = "wheel down",
        ["key.wheelClick"] = "wheel click",
        ...
        ["pic.brightUp"] = "Brighter",
        ["pic.brightDown"] = "Darker",
        ["pic.contrastUp"] = "More Contrast",
        ["pic.contrastDown"] = "Less Contrast",
        ["pic.saturationUp"] = "More Saturation",
        ["pic.saturationDown"] = "Less Saturation",
        ["pic.gammaUp"] = "Gamma Up",
        ["pic.gammaDown"] = "Gamma Down",
        ["pic.reset"] = "Reset Picture",
        ["view.language"] = "Language",
        ["lang.auto"] = "Follow System",
        ["lang.note"] = "The menu bar changes at once. The control bar and the mode panel follow when the player is next started.",
    ...
    private static readonly Dictionary<string, string> Simplified = new()
    {
        ...
        ["vr.recenter"] = "重设头部中心",
        ["vr.resetView.hint"] =
            "把画面转回正前方，清掉鼠标拖动和键盘转视角的偏移。不管头部跟踪开没开都有效。",
        ["vr.recenter.hint"] =
            "把你现在的头部姿势当作新的中立位置。坐姿变了之后用它。仅对头部跟踪有效。",
        ["key.wheelUp"] = "滚轮上滚",
        ["key.wheelDown"] = "滚轮下滚",
        ["key.wheelClick"] = "按下滚轮",
        ["vr.tracking"] = "头部追踪",
        ...
        ["pic.brightUp"] = "调亮",
        ["pic.brightDown"] = "调暗",
        ["pic.contrastUp"] = "提高对比度",
        ["pic.contrastDown"] = "降低对比度",
        ["pic.saturationUp"] = "提高饱和度",
        ["pic.saturationDown"] = "降低饱和度",
        ["pic.gammaUp"] = "提高伽马",
        ["pic.gammaDown"] = "降低伽马",
        ["pic.reset"] = "恢复默认画面",
        ["view.language"] = "语言",
        ["lang.auto"] = "跟随系统",
        ["lang.note"] = "菜单栏立即生效。控制栏和模式面板在下次启动播放器时跟上。",

        ["menu.help"] = "帮助(&H)",
        ["help.keys"] = "快捷键",
        ["help.about"] = "关于",
        ["help.source"] = "源码仓库(GitHub)",
    ...
    private static readonly Dictionary<string, string> Traditional = new()
    {
        ...
        ["vr.recenter"] = "重設頭部中心",
        ["vr.resetView.hint"] =
            "把畫面轉回正前方，清掉滑鼠拖曳和鍵盤轉視角的偏移。不管頭部追蹤有沒有開都有效。",
        ["vr.recenter.hint"] =
            "把你現在的頭部姿勢當作新的中立位置。坐姿變了之後用它。僅對頭部追蹤有效。",
        ["key.wheelUp"] = "滾輪上滾",
        ["key.wheelDown"] = "滾輪下滾",
        ["key.wheelClick"] = "按下滾輪",
        ["vr.tracking"] = "頭部追蹤",
        ...
        ["pic.brightDown"] = "調暗",
        ["pic.contrastUp"] = "提高對比",
        ["pic.contrastDown"] = "降低對比",
        ["pic.saturationUp"] = "提高飽和度",
        ["pic.saturationDown"] = "降低飽和度",
        ["pic.gammaUp"] = "提高伽瑪",
        ["pic.gammaDown"] = "降低伽瑪",
        ["pic.reset"] = "恢復預設畫面",
        ["view.language"] = "語言",
        ["lang.auto"] = "跟隨系統",
        ["lang.note"] = "選單列立即生效。控制列和模式面板在下次啟動播放器時跟上。",

        ["menu.help"] = "說明(&H)",
        ["help.keys"] = "快速鍵",
        ["help.about"] = "關於",
        ["help.source"] = "原始碼倉庫(GitHub)",
    ...
    private static readonly Dictionary<string, string> Japanese = new()
    {
        ...
        ["vr.resetView.hint"] =
            "映像を正面に戻し、マウスドラッグやキーボードで動かした分を打ち消します。ヘッドトラッキングの有無に関係なく使えます。",
        ["vr.recenter.hint"] =
            "いまの頭の位置を新しい基準にします。座り直したあとに使ってください。ヘッドトラッキング専用です。",
        ["key.wheelUp"] = "ホイール上",
        ["key.wheelDown"] = "ホイール下",
        ["key.wheelClick"] = "ホイール押し込み",
        ...
        ["pic.brightUp"] = "明るく",
        ["pic.brightDown"] = "暗く",
        ["pic.contrastUp"] = "コントラストを上げる",
        ["pic.contrastDown"] = "コントラストを下げる",
        ["pic.saturationUp"] = "彩度を上げる",
        ["pic.saturationDown"] = "彩度を下げる",
        ["pic.gammaUp"] = "ガンマを上げる",
        ["pic.gammaDown"] = "ガンマを下げる",
        ["pic.reset"] = "画質をリセット",
        ["view.language"] = "言語",
        ["lang.auto"] = "システムに従う",
        ["lang.note"] = "メニューバーはすぐに切り替わります。コントロールバーとモードパネルは次回起動時に追随します。",

        ["menu.help"] = "ヘルプ(&H)",
        ["help.keys"] = "キーボードショートカット",
        ["help.about"] = "バージョン情報",
        ["help.source"] = "ソースコード (GitHub)",
    ...
    private static readonly Dictionary<string, string> Korean = new()
    {
        ...
        ["vr.resetView.hint"] =
            "화면을 정면으로 되돌리고 마우스 드래그나 키보드로 움직인 만큼을 되돌립니다. 헤드 트래킹과 무관하게 동작합니다.",
        ["vr.recenter.hint"] =
            "지금의 머리 자세를 새로운 기준으로 삼습니다. 자세를 고쳐 앉은 뒤에 쓰세요. 헤드 트래킹 전용입니다.",
        ["key.wheelUp"] = "휠 위로",
        ["key.wheelDown"] = "휠 아래로",
        ["key.wheelClick"] = "휠 클릭",
        ["vr.tracking"] = "헤드 트래킹",
        ...
        ["pic.brightUp"] = "밝게",
        ["pic.brightDown"] = "어둡게",
        ["pic.contrastUp"] = "대비 높이기",
        ["pic.contrastDown"] = "대비 낮추기",
        ["pic.saturationUp"] = "채도 높이기",
        ["pic.saturationDown"] = "채도 낮추기",
        ["pic.gammaUp"] = "감마 높이기",
        ["pic.gammaDown"] = "감마 낮추기",
        ["pic.reset"] = "화면 기본값으로",
        ["view.language"] = "언어",
        ["lang.auto"] = "시스템 설정 따르기",
        ["lang.note"] = "메뉴 막대는 즉시 바뀝니다. 컨트롤 바와 모드 패널은 다음 실행 때 따라옵니다.",

        ["menu.help"] = "도움말(&H)",
        ["help.keys"] = "키보드 단축키",
        ["help.about"] = "정보",
        ["help.source"] = "소스 코드 (GitHub)",
